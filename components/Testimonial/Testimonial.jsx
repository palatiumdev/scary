...
const Testimonial = async ({ channelId, testimonial, videoId }) => {
    ...
    return (
        <div className="bg-accent/50 rounded-3xl p-10 grid gap-4 min-h-fit" >
            <div className="flex w-full justify-between	lg:gap-8 lg:flex-row flex-col gap-4">
                <div className="flex items-center gap-4">
                    ...
                    />
                    <div>
                        <h1 className="text-2xl font-extrabold text-nowrap">{user.username}</h1>
                        <p className="text-xl font-mono">{user.subCount.toLocaleString('de-DE')} Subscribers</p>
                    </div>
